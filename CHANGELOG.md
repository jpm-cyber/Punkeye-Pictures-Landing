...
- Improved default muted text contrast for better readability.
- Added a global `a:focus-visible` treatment for consistent keyboard focus feedback.
- Added an explicit accessibility statement to the 404 page footer for consistency.
